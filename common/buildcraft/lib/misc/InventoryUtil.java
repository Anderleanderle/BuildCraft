...
public class InventoryUtil {
    ...
    @Nonnull
    public static ItemStack addToRandomInventory(World world, BlockPos pos, @Nullable ItemStack stack) {
        if (stack == null) {
    ...
    @Nullable
    public static ItemStack addToRandomInjectable(World world, BlockPos pos, EnumFacing ignore, @Nullable ItemStack stack) {
        if (stack == null) {
            return StackUtil.EMPTY;
        }
        List<EnumFacing> toTry = new ArrayList<>(6);
    ...
    public static void addToBestAcceptor(World world, BlockPos pos, EnumFacing ignore, @Nullable ItemStack stack) {
